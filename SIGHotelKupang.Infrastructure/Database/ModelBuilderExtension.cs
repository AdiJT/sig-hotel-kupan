    ...
    public static ModelBuilder SeedingData(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Hotel>().HasData(
            new Hotel
            {
                ...
                JumlahUlasan = 292,
                Website = [
                    new Uri("https://www.traveloka.com"),
                    new Uri("https://www.booking.com"),
                    new Uri("https://www.agoda.com"),
                    new Uri("https://www.tripadvisor.co.id"),
                    new Uri("https://id.tiket.com"),
                ]
            },
            new Hotel
            {
            ...
            new Hotel
            {
                ...
                Website = [
                    new Uri("https://www.traveloka.com"),
                    new Uri("https://www.tiket.com"),
                    new Uri("https://www.oyorooms.com"),
                    new Uri("https://www.booking.com"),
                ]
            },
            new Hotel
